    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div id="pengendara" class="form-box active">
                ...
                <form id="formPengendara" action="process_register_pengendara.php" method="POST" onsubmit="return validateForm('pengendara')">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email_pengendara" class="form-control" placeholder="contoh@email.com" required onblur="checkEmail(this, 'pengendara')">
                        <div class="invalid-feedback"></div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="no_telepon" id="no_telepon_pengendara" class="form-control" placeholder="08xxxxxxxxxx" required pattern="[0-9]{10,15}" maxlength="20">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Password harus minimal 8 karakter, kombinasi huruf besar, kecil, angka & simbol.</small>
                        <div class="invalid-feedback"></div>
                    </div>
            ...
            <div id="mitra" class="form-box">
                ...
                <form id="formMitra" action="auth/process_register_mitra.php" method="POST" onsubmit="return validateForm('mitra')">
                    <div class="mb-3">
                        <label class="form-label">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email_mitra" class="form-control" placeholder="contoh@email.com" required onblur="checkEmail(this, 'mitra')">
                        <div class="invalid-feedback"></div>
                        <div class="valid-feedback">Email tersedia!</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="no_telepon" id="no_telepon_mitra" class="form-control" placeholder="08xxxxxxxxxx" required pattern="[0-9]{10,15}" maxlength="20">
                        <div class="invalid-feedback">Format nomor telepon tidak valid (10-15 digit).</div>
                    </div>
...
function checkPasswordStrength(field, type) {
    ...
    if (password.length >= 8 && /[a-z]/.test(password) && /[A-Z]/.test(password) && /[0-9]/.test(password) && /[^a-zA-Z0-9]/.test(password)) {
        ...
        if (password.length > 0) {
            ...
            field.nextElementSibling.nextElementSibling.textContent = 'Password harus mengandung huruf besar, kecil, angka, dan simbol.';
        }
    }
}
...
function checkPasswordMatch(type) {
    ...
    const feedback = confirmField.nextElementSibling.nextElementSibling;
...
function checkEmail(field, type) {
    ...
    emailTimeout = setTimeout(() => {
        fetch(`auth/check_email.php?email=${encodeURIComponent(email)}&type=${type}`)
            .then(response => response.json())
            .then(data => {
                if (data.exists) {
                    field.classList.remove('is-valid');
                    field.classList.add('is-invalid');
                    field.nextElementSibling.textContent = 'Email sudah terdaftar!';
                } else {
                    field.classList.remove('is-invalid');
                    field.classList.add('is-valid');
                }
...
function validateForm(type) {
    ...
    if (!/[a-z]/.test(password) || !/[A-Z]/.test(password) || !/[0-9]/.test(password) || !/[^a-zA-Z0-9]/.test(password)) {
        alert('Password harus mengandung huruf besar, kecil, angka, dan simbol!');
        valid = false;
    }
    
    if (valid) {
        document.getElementById('btn' + type.charAt(0).toUpperCase() + type.slice(1)).disabled = true;
        document.getElementById('btn' + type.charAt(0).toUpperCase() + type.slice(1)).innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Memproses...';
    }
